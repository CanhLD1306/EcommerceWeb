...
namespace EcommerceWeb.Models
{
    public partial class dbEcommerceContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
                optionsBuilder.UseSqlServer("Data source=DESKTOP-H82RVEH\\DUCCANH; Initial Catalog=dbEcommerce; Integrated Security=true; User ID =sa; Password=Admin31148");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<AttributesPrice>(entity =>
            {
                ...
                entity.Property(e => e.AtrributesId).HasColumnName("AtrributesID");

                entity.Property(e => e.ProductId).HasColumnName("ProductID");

                entity.HasOne(d => d.Atrributes)
                    .WithMany(p => p.AttributesPrices)
                    .HasForeignKey(d => d.AtrributesId)
