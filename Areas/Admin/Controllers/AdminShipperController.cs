...
namespace EcommerceWeb.Areas.Admin.Controllers
{
    ...
    public class AdminShipperController : Controller
    {
        ...
        public AdminShipperController(dbEcommerceContext context)
        {
            _context = context;
        }
        ...
        // GET: AdminShipper/Create
        public IActionResult Create()
        {
            return View();
        }

        // POST: AdminShipper/Create
