...
namespace EcommerceWeb.Areas.Admin.Controllers
{
    ...
    public class AdminOrderController : Controller
    {
        ...
        public AdminOrderController(dbEcommerceContext context)
        {
            _context = context;
        }
        ...
        {
            var dbEcommerceContext = _context.Orders.Include(o => o.Customer).Include(o => o.TransactStatus);
        ...
        public async Task<IActionResult> Create([Bind("OrderId,CustomerId,OrderDate,ShipDate,TransactStatusId,Deleted,Paid,PaymentDate,PaymentId,Note")] Order order)
        {
            ...
            ViewData["CustomerId"] = new SelectList(_context.Customers, "CustomerId", "Password", order.CustomerId);
